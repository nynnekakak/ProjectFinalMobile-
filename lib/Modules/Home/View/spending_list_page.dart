// ✅ Đã sửa lỗi "BOTTOM OVERFLOWED BY ... PIXELS"
// ✅ Bằng cách bọc `Column` trong `ListView` thay vì dùng `SingleChildScrollView + IntrinsicHeight`
...
class ListSpendingPage extends StatefulWidget {
  const ListSpendingPage({super.key});
